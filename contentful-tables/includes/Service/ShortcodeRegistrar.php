...
final class ShortcodeRegistrar implements LoadableInterface {
	...
	public function register(): void {
		...
		\add_shortcode( 'contentful_toc', array( $this, 'render_toc_shortcode' ) );
		\add_shortcode( 'contentful-toc', array( $this, 'render_toc_shortcode' ) );
		\add_shortcode( 'contentful_chart', array( $this, 'render_chart_shortcode' ) );
		\add_shortcode( 'contentful-chart', array( $this, 'render_chart_shortcode' ) );
		\add_shortcode( 'contentful_cards', array( $this, 'render_cards_shortcode' ) );
		\add_shortcode( 'contentful-cards', array( $this, 'render_cards_shortcode' ) );
		\add_shortcode( 'contentful_form', array( $this, 'render_form_shortcode' ) );
		\add_shortcode( 'contentful-form', array( $this, 'render_form_shortcode' ) );
	...
	public function enqueue_styles(): void {
		...
		if ( \file_exists( $css_file ) ) {
			...
			\wp_register_style( 'contentful-tables', false, array(), CTFL_TABLES_VERSION );
	...
	public function render_table_shortcode( $atts ): string {
		...
		if ( ! empty( $custom_class ) ) {
			$html = \str_replace(
				array( 'class="contentful-table-of-contents"', 'class="contentful-data-table"' ),
				array( 'class="contentful-table-of-contents ' . \esc_attr( $custom_class ) . '"', 'class="contentful-data-table ' . \esc_attr( $custom_class ) . '"' ),
				$html
			);
		}
